...
/**
 * A utility class for handling Minecraft version-related operations. This class provides methods to
 * retrieve and parse the version of the running Minecraft server.
 *
 * <p>It specifically retrieves the minor version number of the Minecraft server (e.g., "1.16" ->
 * "16"). This can be useful for checking compatibility with certain Minecraft versions.
 *
...
public abstract class VersionUtils {
  ...
  /**
   * Retrieves the minor version of the Minecraft server. It parses the server's version string
   * (e.g., "MC: 1.16") and extracts the minor version number.
   *
  ...
  public static int getMCVersion() {
    ...
    // Define the regex pattern to match "MC: 1.16" or "MC: 26.1.2"
